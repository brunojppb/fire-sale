defmodule FireSaleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FireSaleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FireSaleWeb.Gettext, "errors", msg, opts)
    end
  end
