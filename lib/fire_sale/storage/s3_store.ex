defmodule FireSale.Storage.S3Store do
  @moduledoc """
  File upload handling for S3-compatible storage
  """
  @behaviour FireSale.Storage.FileStore
  ...
  def get_file(filename) do
    ...
    try do
      stream =
        get_bucket_name()
        |> ExAws.S3.download_file(file_path, :memory)
        |> ExAws.stream!()
  ...
  defp get_bucket_name() do
    Application.fetch_env!(:fire_sale, :s3_bucket_name)
  end
end
