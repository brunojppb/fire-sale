...
#
#     PHX_SERVER=true bin/fire_sale start
#
...
if System.get_env("S3_BUCKET_NAME") &&
  ...
  config :fire_sale, s3_bucket_name: System.get_env("S3_BUCKET_NAME")
  ...
  config :fire_sale, :file_store, FireSale.Storage.S3Store
end
...
if config_env() == :prod do
  ...
  config :fire_sale, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
